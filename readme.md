...
| Screen | Description |
|---|---|
| ![Mobile Home Feed](docs/mobile-home.png) | Vertical “TikTok-style” video scroll feed |
| ![Mobile Upload / Partner View](docs/mobile-upload.png) | Food partner upload / management view |

...
| Screen | Description |
|---|---|
| ![Mobile Home Feed](docs/user-phone.png) | Vertical “TikTok-style” video scroll feed |
| ![Mobile Upload / Partner View](docs/partner-phone.png) | Food partner upload / management view |
